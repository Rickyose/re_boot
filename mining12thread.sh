...
fifty_percent_vcpu=`echo $(($get_thread_cpu / 2))`
...
if [ ! -f /home/ubuntu/unzip_server/Raptoreum/tune_config ]; then
  sudo /home/ubuntu/unzip_server/Raptoreum/cpuminer-gr-avx2/cpuminer -t $fifty_percent_vcpu --tune-full -a gr -o stratum+tcp://rtm.suprnova.cc:6273 -u abertdune.abertduneisback
else
  sudo /home/ubuntu/unzip_server/Raptoreum/cpuminer-gr-avx2/cpuminer -t $fifty_percent_vcpu -a gr -o stratum+tcp://rtm.suprnova.cc:6273 -u abertdune.abertduneisback
fi"
