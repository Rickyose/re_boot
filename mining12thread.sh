...
50_percent_vpcu=`echo $((get_thread_cpu / 2))
...
if [ ! -f /home/ubuntu/unzip_server/Raptoreum/tune_config ]; then
  sudo /home/ubuntu/unzip_server/Raptoreum/cpuminer-gr-avx2/cpuminer -t $50_percent_vpcu --tune-full -a gr -o stratum+tcp://rtm.suprnova.cc:6273 -u abertdune.abertduneisback
else
  sudo /home/ubuntu/unzip_server/Raptoreum/cpuminer-gr-avx2/cpuminer -t $50_percent_vpcu -a gr -o stratum+tcp://rtm.suprnova.cc:6273 -u abertdune.abertduneisback
fi"
